...
import de.uhi.enia.ridesafe.core.components.map.MapSurface
 ...
 * the camera's target.
 *
 * Plain in-hierarchy content for [de.uhi.enia.ridesafe.core.components.map.FullScreenMapHost],
 ...
 * [de.uhi.enia.ridesafe.core.components.map.FullScreenMapRequest]).
 */
