...
import de.uhi.enia.ridesafe.feature.analysisqueue.ui.AnalysisQueueScreen
import de.uhi.enia.ridesafe.feature.logbook.ui.MergedRideDetailScreen
import de.uhi.enia.ridesafe.feature.logbook.ui.RideDetailScreen
import de.uhi.enia.ridesafe.feature.logbook.ui.RidesScreen
import de.uhi.enia.ridesafe.feature.refuel.ui.RefuelFormScreen
import de.uhi.enia.ridesafe.feature.refuel.ui.RefuelLoadingScreen
import de.uhi.enia.ridesafe.feature.refuel.ui.RefuelUnavailableScreen
...
fun EntryProviderScope<NavKey>.ridesEntries(
    ...
    entry<EditRefuelRoute>(metadata = ListDetailSceneStrategy.detailPane(sceneKey = RIDES_SCENE)) { key ->
        val loaded by produceState<Result<de.uhi.enia.ridesafe.data.entity.Refuel?>?>(initialValue = null, key.id) {
