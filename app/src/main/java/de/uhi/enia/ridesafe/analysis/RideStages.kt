...
import de.uhi.enia.ridesafe.analysis.event.ForwardAxisEstimator
import de.uhi.enia.ridesafe.analysis.event.RideEventConfig
import de.uhi.enia.ridesafe.analysis.event.StreamingDetector
import de.uhi.enia.ridesafe.analysis.score.ScoreWeights
import de.uhi.enia.ridesafe.analysis.score.ecoLevel
import de.uhi.enia.ridesafe.analysis.score.rideEcoProfile
import de.uhi.enia.ridesafe.analysis.score.scoreRide
...
import de.uhi.enia.ridesafe.data.file.trackDistanceMeters
 ...
 * [de.uhi.enia.ridesafe.data.entity.SafetyScore].
 */
class ScoreStage(
    private val db: RidesafeDatabase,
) : RideStage {
